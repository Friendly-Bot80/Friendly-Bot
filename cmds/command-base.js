...
//const commandPrefixSchema = require('../models/3prefix-schema')
const { prefix: globalPrefix } = require('../util/config.json')
...
/**
 * const { prefix: globalPrefix } = require('./../Utils/config.json')
const guildPrefixes = {} // { 'guildId' : 'prefix' }
