...
module.exports = {
    commands: ['play', 'p'],
    minArgs: 1,
    expectedArgs: "Please provide a song name or link related to it.",
    ...
    callback: async (message, arguments, client) => {
        ...
        if (!searchString) return sendError("You didn't poivide want I have to play", message.channel);
        ...
        const play = async (song) => {
            ...
            if (!song) {
                sendError(
                    "Leaving the voice channel because I think there are no songs in the queue. If you like the bot stay 24/7 in voice channel ask Aryan For help",
                    message.channel
                );
